...
In the first part of the guide we tried to explain what content markting is. In the rest of the guide, we will try to explain a few concepts which might help you create awesome content marketing. Everything beyond this point is our own interpretation and by no means an unwavering truth.
...
In advertising, when you have people speaking for you or even endorsing you, you have the same problem as with branding. The personal incentive, which made it valuable, is removed the moment it is suspected there is money involved.
...
For more on social media, you can check our [guide on social media](https://hub.com/newatoms/newatoms/blob/ready/internal/guides/using-social-media-as-communication-tool.md).
