...
The challenge, therefore, is not how to make the best blog post, but how to do this in a way that requires the smallest amount of effort but still makes it better than it was before, or adds value. This way you can still break it up into smaller parts, but you are never obligated to continue working on something to make it publishable. **It also means that in a perfect world you can close your laptop at any moment and have a publishable story.** Never be afraid that something is not as good as it could be, only focus on making it better than that it was before. This way of working enables an blog post to become a little bit better every time, without the pressure of perfection.
