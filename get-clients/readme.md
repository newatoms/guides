...
Even though we do need to sell our service, we only want to sell our services to people who can actually benefit from it. Working with a person who does not value your services for what it is will require you to keep convincing them of every step you take, making it extremely counter productive.

## The two ways to acquire customers

There are two ways in which you can convince people to use your product of service. **By directly convincing a specific person**, or indirectly **trough your general communication**. With your general communication you can have a potentially infinite reach, but have very little control over who you reach.

The main difference between the two is that direct customer acquisition take more effort per client, but can be done with very little means. Acquiring customers trough your general communication is a lot more effective but requires you to actually have a form of communication, which takes a lot of effort and money to build.
...
* Can you formulate a tangible example of the added value of using your service for the prospect/company
...
* Can you formulate a tangible example of the added value of using your service for the prospect/person
...
* Can you formulate a tangible example of the added value of using your service in relation to your similarities.


## Direct customer acquisition by phone

Phone calls are by far the most efficient (and scariest) way of direct customer acquisition. The reason it is so effective, is the fact that it is just a conversation. You can use everything you learned by answering the questions above and use that information to steer the conversation in the direction that you want.

While making a phone call it is super mega important to realize you are talking to a person, who has its own values, ambitions, hopes and dreams. Don't become a manipulative sales robot (asshole). Be a person and try to have some fun.
...
In general I would strongly recommend against using email as your sole form of contact with your prospect. The main reason for this is that you never know if and when the email is read. Unless you can create necessity for the prospect in your email the chances are big that the receiver decides to look at your email later, and then forgets about it.

### Email as first contact

The world we live in is not a perfect one and sometimes this means you will have to do business trough email, or send an email before you can call some on.
...
* Shortly explain who you are and who you work for.
* Shortly explain the gist of you service specified to the relevance it has to the prospect, both personally as professionally.
* If you do not have the phone number of the person in question, state what you want to discuss and suggest to do it trough phone or, if possible, in person.

### Email as follow up

When your write an email as a follow up to a phone conversation make sure too keep the following things in mind
...
* Deliver what you promised to deliver on the phone, usually this is extra info, prizes, website links, portfolios etc. Do this in such a way that it is in line with your conversation with the prospect.
...
If your know the prospect directly or someone you know can introduce you to the prospect answers on the following questions will probably help you sell your service.
