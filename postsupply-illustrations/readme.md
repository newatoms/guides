...
* **Everyone is free to add more styles to this guide**, but it should only be applied to illustrations that are clearly used in a different way/for a different purpose. So rather than simple illustrations that serve to illustrate features, you might think of a big illustration for the heading of the website, telling a story on its own. Or a small icon used to clarify a button. Or...
